...
%%%%%%%%%%%% FIRST-VISIT MC PREDICTION (STATE VALUES)
\begin{algorithm}
...
%%%%%%%%%%%% FIRST-VISIT MC PREDICTION (ACTION VALUES)
\begin{algorithm}
	\KwIn{policy $\pi$, positive integer $num\_episodes$}
...
%%%%%%%%%%%% GLIE MC CONTROL
\begin{algorithm}
	\KwIn{positive integer $num\_episodes$}
...
\begin{algorithm}
	\KwIn{positive integer $num\_episodes$, small positive fraction $\alpha$}
    	\KwOut{policy $\pi$ ($\approx \pi_*$ if $num\_episodes$ is large enough)}
...
%%%%%%%%%%%% Sarsa
\begin{algorithm}
	\KwIn{policy $\pi$, positive integer $num\_episodes$, small positive fraction $\alpha$}
    	\KwOut{value function $Q$ ($\approx q_\pi$ if $num\_episodes$ is large enough)}
